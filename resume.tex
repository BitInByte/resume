...
% Background Color
\colorlet{highlightbarcolor}{lightergray}
...
\include{content/topInfo/topinfo}

\makeheader

\highlightbar{

    \input{content/highlightbar/contact}

    \input{content/highlightbar/skills}

    % \input{content/highlightbar/certificates}

}

\mainbar{

    \input{content/body/aboutme.tex}

    \input{content/body/work.tex}

    \input{content/body/education.tex}

    \input{content/body/certificates.tex}

    \input{content/body/projects.tex}
